...
function Tshirt({ itemImage, itemImage2, itemImage3, itemImage4, itemRatingStars, itemRatingCount, itemName, itemCurrentPrice, itemOriginalPrice, discount, modalId }) {
                ...
                <div className="flex flex-col md:flex md:flex-row">
                  ...
                  <div className="card-body">
                    ...
                    <div className='flex flex-row justify-between items-center my-2'>
                      ...
                      <button className='bg-slate-200 p-4 hover:border-black hover:border-2'>S</button>
                      <button className='bg-slate-200 p-4 hover:border-black hover:border-2'>M</button>
                      <button className='bg-slate-200 p-4 hover:border-black hover:border-2'>L</button>
                      <button className='bg-slate-200 p-4 hover:border-black hover:border-2'>XL</button>
                    </div>
